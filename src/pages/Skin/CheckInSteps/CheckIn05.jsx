...
const CheckIn05 = ({ onRecovery, onExit }) => {
    return (
        <div className="checkin05_wrap">
            <img src={CheckinFinIcon} alt="" />
            <p className='check05_txt'>분석이 완료되었어요.<br />이어서 3분 회복 모드를 진행할까요?</p>
            <button className='checkin05_refresh' onClick={onRecovery}>3분 회복 모드 진행하기</button>
            <button className='checkin05_exit' onClick={onExit}>나가기</button>
        </div>
    )
}
